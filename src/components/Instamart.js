...
const Section = ({title,description, isVisible,setVisible}) =>{
    ...
    return(
        <div className="border border-black p-2 m-2">
            ...
            {
                isVisible 
                ?  <button className="cursor-pointer underline" onClick={()=>setVisible(false)}>hide</button>
                 :  <button className="cursor-pointer underline" onClick={()=> setVisible(true)}>show</button> 
